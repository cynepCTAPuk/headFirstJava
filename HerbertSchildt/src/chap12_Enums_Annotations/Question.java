...
/* An improved version of the "Decision Maker" prorgam from Chapter 9. This version
 uses an enum, rather than interface varables, to represent the answers
 */
...
class Question {
    ...
    Answers ask() {
        ...
        if (prob < 30) return Answers.NO; // 15%

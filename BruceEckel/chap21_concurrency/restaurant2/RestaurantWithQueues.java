//: chap21_concurrency/restaurant2/RestaurantWithQueues.java
// {Args: 5}
package chap21_concurrency.restaurant2;
import chap19_enumerated.menu.*;
...
class WaitPerson implements Runnable {
    ...
    public void placeOrder(Customer cust, Food food) {
        ...
        } catch(InterruptedException e) { print(this + " placeOrder interrupted");}
    }
    public void run() {
        try {

//: chap21_concurrency/CarBuilder.java
...
class ChassisBuilder implements Runnable {
    ...
    public void run() {
        ...
        } catch(InterruptedException e) { print("Interrupted: ChassisBuilder");}
...
class Assembler implements Runnable {
    ...
    public void run() {
        ...
        } catch(InterruptedException e) { print("Exiting Assembler via interrupt");
...
abstract class Robot implements Runnable {
    ...
    public void run() {
        ...
        } catch(InterruptedException e) { print("Exiting " + this + " via interrupt");
        } catch(BrokenBarrierException e) {
            // This one we want to know about
            throw new RuntimeException(e);
        }
...
class RobotPool {
    ...
    hire(Class<? extends Robot> robotType, Assembler d) throws InterruptedException {
        for(Robot r : pool)

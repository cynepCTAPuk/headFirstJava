...
public class JavaFxHelloWorld extends Application {
    ...
    public void start(Stage primaryStage) {
        final Button button = new Button(); // Creating the Java button
        button.setText("type \"Hello World\" to console"); // Setting text to button
        ...
        final Scene scene = new Scene(root, 250, 50); // Creating a scene object
        primaryStage.setTitle("Hello World!"); // Adding the title to the window (primaryStage)
    ...
    public void stop() {
        ...
        //closing the window or if Platform.exit() is called. Use Platform.exit() instead of System.exit(0).
        //This is where you should offer to save any unsaved stuff that the user may have generated.
    }

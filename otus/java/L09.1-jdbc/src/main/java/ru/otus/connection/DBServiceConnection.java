...
public class DBServiceConnection implements DBService {
    ...
    public DBServiceConnection() {connection = ConnectionHelper.getConnection();}
    ...
    @Override
    public String getUserName(int id) throws SQLException {return null;}
    @Override
    public List<String> getAllNames() throws SQLException {return new ArrayList<>();}
    @Override
    public List<UsersDataSet> getAllUsers() throws SQLException {return new ArrayList<>();}
    @Override

...
public class MongoMain {
    ...
    private void example() {
        ...
        System.out.println("\nFind by name result: ");
        for (Document document : iterable) System.out.println(document);
        ...
        System.out.println("\nFind by id result: ");
        for (Document document : iterableID) System.out.println(document);
    ...
    private void listDatabaseNames() {
        ...
        System.out.println("\nDatabase names:");
        for (String db : dbs) System.out.println(db);
    }

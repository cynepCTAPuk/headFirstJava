package concurrency.javarush.task2808;
...
public class Solution {
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 1000; i <= 1010; i++) futures.add(executor.submit(getTask(i)));
    ...
    public static Callable<String> getTask(final int i) throws Exception {
        Callable<String> callable = new Callable<String>() {
            ...
            public String call() throws Exception {
                ...
                for (int j = 1; j <= i; j++) result = result.add(BigInteger.valueOf(j));

...
public class Test3 {
    public static void main(String[] args) {
        ...
        assert mailBox.get("Christopher Nolan").equals(Arrays.asList(
                "Брат, почему все так хвалят только тебя, когда практически " +
                        "все сценарии написал я. Так не честно!",
                "Я так и не понял Интерстеллар.")
        ) : "wrong mailService mailbox content (2)";
        assert mailBox.get(randomTo).equals(
                Collections.<String>emptyList()) : "wrong mailService mailbox content (3)";
...
*/
    ...
    public static class MailService implements Consumer<MailMessage> {
...
//            map.put(null, Collections.emptyList());
        ...
        public void accept(MailMessage mailMessage) {
            ...
            map.get(to).add(mailMessage.getContent());
        }
    }
    ...
    public static class Salary {
        ...
        public Salary(String company, String name, int sum) {

...
public class Field {
    ...
    public void removeFullLines() {
        ...
        int size = list.size();
        for (int i = 0; i < height - size; i++) list.add(0, new int[width]);
        for (int i = 0; i < height; i++) matrix[i] = list.get(i);
    }

    public static void main(String[] args) {
        Field field = new Field(5, 5);
        field.matrix[0] = new int[]{0, 0, 0, 1, 0};
        field.matrix[1] = new int[]{1, 1, 1, 1, 1};
        field.matrix[2] = new int[]{0, 1, 0, 1, 0};
        field.matrix[3] = new int[]{1, 1, 1, 1, 1};
        field.matrix[4] = new int[]{1, 1, 0, 1, 1};
        field.removeFullLines();
        printMatrix(field);
    }

    public static void printMatrix(Field field) {

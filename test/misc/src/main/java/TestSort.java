...
*/
        System.out.println();
        System.out.println(String.format("com.example.Bubble\ttime nanoseconds\t%,.0f", tBubble));
        System.out.println(String.format("BubbleS\ttime nanoseconds\t%,.0f", tBubbleSort));
        System.out.println(String.format("com.example.OddEven\ttime nanoseconds\t%,.0f", tOddEven));
        System.out.println(String.format("ShakeCl\ttime nanoseconds\t%,.0f", tShakeClassic));
        System.out.println(String.format("com.example.Shake\ttime nanoseconds\t%,.0f", tShake));
    }
}

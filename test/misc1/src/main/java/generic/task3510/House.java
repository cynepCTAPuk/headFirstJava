...
/*
    private void checkConflicts() {
        ...
        for (Object resident : residents) {
            if (resident instanceof Dog) conflict = true;
        }
        ...
        if (conflict) {
            ...
            while (iterator.hasNext()) {
                ...
                if (resident instanceof Cat) iterator.remove();
            }
        }
    }
*/
    ...
    public String toString() {
        ...
        for (Object resident : residents) builder.append(resident.toString()).append("\n");

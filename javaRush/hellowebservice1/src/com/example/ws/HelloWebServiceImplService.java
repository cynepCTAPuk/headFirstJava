 ...
 */
@WebServiceClient(name = "HelloWebServiceImplService", targetNamespace = "http://ws.example.com/", wsdlLocation = "http://localhost:1986/wss/hello?wsdl")
public class HelloWebServiceImplService extends Service {
    ...
    private final static QName HELLOWEBSERVICEIMPLSERVICE_QNAME = new QName("http://ws.example.com/", "HelloWebServiceImplService");
    ...
    public HelloWebService getHelloWebServiceImplPort() {
        return super.getPort(new QName("http://ws.example.com/", "HelloWebServiceImplPort"), HelloWebService.class);
    }
    ...
    public HelloWebService getHelloWebServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.example.com/", "HelloWebServiceImplPort"), HelloWebService.class, features);
    }

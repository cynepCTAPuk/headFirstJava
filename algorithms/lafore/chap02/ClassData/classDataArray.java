package lafore.chap02.ClassData;
...
class ClassDataArray {
  ...
  //--------------------------------------------------------------
  public Person find(String searchName) {                         // search specified value
    int j;
  ...
  public boolean delete(String searchName) {                      // delete person from array
    ...
    if (j == nElems) return false;                                // can't search it
      ...
      for (int k = j; k < nElems; k++) a[k] = a[k + 1];           // shift down
  ...
  public void displayA() {                                        // displays array contents
    for (int j = 0; j < nElems; j++) a[j].displayPerson();        // for each element & display it
  }
//--------------------------------------------------------------
